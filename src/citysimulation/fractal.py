...
# Random cornerpoint selection
    ...
    # main(0, 800, 800, 5, 0.5)
    # main(0, 800, 800, 5, 0.62)
    # main(0, 800, 800, 6, 0.6)
    
# # Cornerpoints cannot be chosen twice in a row
    main(1, 800, 800, 4, 0.5)
...
# the other points are for other shapes(the first number is changing the shape of the fractal, the two 1000's are for the window size
# the 3, 4, 5, 6 are for the number of sides we want to have and the last number is to control how far the shapes get from each other)